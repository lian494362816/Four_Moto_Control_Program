...
//                printf("ultra_speed=%f\r\n", ultra_speed);//值不为0
                ...
                {				
                    Ultra_Ctrl(15.0f*TT,thr_lpf);//realtime是周期为 TT 秒的，#define TT 0.0065 //控制周期13ms
                    ultra_start_f = -1;
//                    printf("5\r\n");
                }
            }
...
{
    exp_height_speed = ULTRA_SPEED *my_deathzoom_2(thr - 1400,100)/300.0f; //20这里具体根据自己起飞油门定，油门控制高度+-ULTRA_SPEEDmm / s
